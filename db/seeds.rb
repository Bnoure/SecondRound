...
final = Game.create!(title: 'Final fantasy', category: 'RPG', price: 257, console: xbox, description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', year: 1980, condition: 'neuf', store_id: superthor.id)
...
barbie = Game.create!(title: 'Barbie fait la vaisselle', category: 'simlutaion réaliste', price: 55, console: switch, description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', year: 1980, condition: 'neuf', store_id: tekkenstore.id)
