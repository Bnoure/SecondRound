...
superthor = Store.create!(name: 'superThor', city: 'Toulouse', address: '62 avenue Albert Bedouces', user_id: nour.id, open_hour: 9 , close_hour: 22)
tekkenstore = Store.create!(name: 'TekkenStore', city: 'Strasbourg', address: '3 rue Sarrelouis', user_id: emma.id, open_hour: 8, close_hour: 18)
